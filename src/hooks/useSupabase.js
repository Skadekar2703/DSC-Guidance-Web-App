...
export const normalizeRow = (row) => {
  ...
  return {
    ...
    testLink: row.pdf_url || row.pdfUrl || row.external_url || row.externalUrl || row.testLink || "",
    ...
    logoUrl: row.logo_url || row.logoUrl || row.logo_image_url || row.logoImageUrl || null,
    logo_url: row.logo_url || row.logoUrl || row.logo_image_url || row.logoImageUrl || null,
    logoImageUrl: row.logo_url || row.logoUrl || row.logo_image_url || row.logoImageUrl || null,
    logo_image_url: row.logo_url || row.logoUrl || row.logo_image_url || row.logoImageUrl || null,
    role: row.role || "tutor",
    createdAt: {
      seconds,
      toDate: () => createdAt,
